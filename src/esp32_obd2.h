...
enum BMW
{
  ...
  ENGINE_TORQUE_ALT = 0x07D2,
  THROTTLE_VALVE = 0x0045,
  INJECTION_VOLUME = 0x04B0, // mm^3/inj
  INJECTION_QUANTITY = 0x0500,
  TOTAL_FLOW_INJ = 0x0939,
  ACC_FUEL_AMOUNT = 0x093A,
  VEHICLE_SPEED_ALT = 0x0B40,
  ...
  VEHICLE_ACC = 0x0B41,
  DPF_REGEN_REQ = 0x0404,
  ODOMETER = 0x05DD,
  AVG_FUEL_CONSUM = 0x0450,
  ACCU_FUEL_CONSUM = 0x0452,
